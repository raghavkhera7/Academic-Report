...
private SharedPref sharedPref;
    ...
    @OnClick({R.id.email_sign_in_button,R.id.email_sign_up_button,R.id.gsign_in_button})
    public void onclick(View view){
        ...
        else  if(R.id.gsign_in_button == id){
...
private void signin(String email,String password){
            ...
            .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        errortext.setText("Invalid Username Or password . New User need to Signup");
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            sharedPref.setTeacher();
            startActivity(new Intent(LoginActivity.this,TeacherMain.class));
            finish();
           //suvccess
        }
    }
